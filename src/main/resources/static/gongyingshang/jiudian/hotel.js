...
function showTrainSchemeTable(pageInfo){
    ...
    for (var i = 0, length_1 = trainschemes.length; i < length_1; i++) {
        ...
        html += '<img src="/layui/images/' + enterprise.imageList[0].img_path + '" style="width: 250px; height: 110px; margin: 2px 3px 1px 16px; border: 1px solid silver;" />';
        html += '<h5 hotel_id="' + enterprise.hotel_id + '">&nbsp;&nbsp;&nbsp;&nbsp;【' + enterprise.hotel_name + '】</h5>';
        if (enterprise.relationList == null || enterprise.relationList ==''){
            html += '<p>&nbsp;&nbsp;&nbsp;&nbsp;<span class="tit">联系人：</span></p>';
            html += '<p>&nbsp;&nbsp;&nbsp;&nbsp;<span class="tit">联系电话：</span></p>';
            html += '</a>';
            html += '</div>';
        }else{
            html += '<p>&nbsp;&nbsp;&nbsp;&nbsp;<span class="tit">联系人：' + enterprise.relationList[0].relation_name + '</span></p>';
            html += '<p>&nbsp;&nbsp;&nbsp;&nbsp;<span class="tit">联系电话：' + enterprise.hotel_phone + '</span></p>';
            html += '</a>';
            html += '</div>';
        }
        $("#form_page").html(html);
        alert(total+"-"+pageNum+"-"+pageSize);
    }
